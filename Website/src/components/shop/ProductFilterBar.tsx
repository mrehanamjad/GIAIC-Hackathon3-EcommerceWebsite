...
// function ProductFilterBar({showSideFilterBarFunc}:{showSideFilterBarFunc:()=>void}) {
//   return (
...
//               </span>
//             </div>
//             <div className="h-5 w-0.5 bg-black/80 max-sm:hidden"></div>{" "}
//             {/* vertical line */}
...
//               value={"16"}
//               id="show"
//               className="text-[#9F9F9F] w-12 h-12 max-md:h-9 text-center"
//             />
...
//               value={"Default"}
//               id="sort"
//               className="text-[#9F9F9F] w-24 h-12 max-md:h-9 text-center"
//             />
//           </div>
//         </div>
//       </Container>
